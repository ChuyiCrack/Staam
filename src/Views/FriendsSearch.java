 ...
 * @author Tryst
 */
public class FriendsSearch extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FriendsSearch.class.getName());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FriendsSearch().setVisible(true));
    }
